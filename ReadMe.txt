...
进度记录：
5)2021/6/16 上传了几张效果较好的图片至output

4)2021/6/9 上传开题报告，中期报告,及其分工上传至Report；
           最终模型代码上传至code；
           迭代次数为30000次的小狗生成输出上传至output;
           调用模型的代码以市场至model;
           

3)2021/5/25 模型运行完毕，在修改参数中寻找较好的效果;
            模型已导出，并与前端连接成功;

2)2021/5/13 软件前端搭建完毕

1）2021/5/5 模型搭建完毕，正在处理参数并运行模型
