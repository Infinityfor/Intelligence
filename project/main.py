...
class Doge(QWidget):
    def aboutUsEvent(self, event):
        reply = QMessageBox.question(self, 'DOGE', '我们拥有一个非常好的团队，互相合作共同完成了这个课程项目。一路有你们，真好！\n项目会在github上开源，有兴趣的小伙伴记得点亮星星哦！',QMessageBox.Yes)
    ...
    def read(self):
        ...
        if n<10:
            ...
            n=str(n)
        self.pic='output_images\image_000'+n+'.png'
        self.label_doge.setPixmap(QPixmap(self.pic))
    ...
    def initUI(self):
        ...
        palette = QPalette()
        palette.setColor(QPalette.Background, QColor(255, 239, 219, 255))
        ...
        label_background.setGeometry(0,0,800,500)

        self.label_doge = QLabel(self)
        self.label_doge.setPixmap(QPixmap(self.pic))
        self.label_doge.setGeometry(230, 50, 450, 400)
        self.label_doge.setScaledContents(True)

        label_icon1 = QLabel(self)
        label_icon1.setPixmap(QPixmap('img\icon.png'))
        label_icon1.setGeometry(730, 100, 45, 40)
        label_icon1.setScaledContents(True)

        label_icon2 = QLabel(self)
        label_icon2.setPixmap(QPixmap('img\icon0.png'))
        label_icon2.setGeometry(730, 150, 45, 40)
        label_icon2.setScaledContents(True)

        label_icon3 = QLabel(self)
        label_icon3.setPixmap(QPixmap('img\icon2.png'))
        label_icon3.setGeometry(730, 200, 45, 40)
        label_icon3.setScaledContents(True)

        label_icon4 = QLabel(self)
        label_icon4.setPixmap(QPixmap('img\icon1.png'))
        label_icon4.setGeometry(730, 250, 45, 40)
        label_icon4.setScaledContents(True)

        label_icon5 = QLabel(self)
        label_icon5.setPixmap(QPixmap('img\icon.png'))
        label_icon5.setGeometry(730, 300, 45, 40)
        label_icon5.setScaledContents(True)

        label_icon6 = QLabel(self)
        label_icon6.setPixmap(QPixmap('img\icon.png'))
        label_icon6.setGeometry(730, 350, 45, 40)
        label_icon6.setScaledContents(True)

        label_icon7 = QLabel(self)
        label_icon7.setPixmap(QPixmap('img\icon2.png'))
        label_icon7.setGeometry(730, 400, 45, 40)
        label_icon7.setScaledContents(True)

        label_scnu = QLabel(self)
        label_scnu.setPixmap(QPixmap('img\scnu.png'))
        label_scnu.setGeometry(30, 400, 100, 70)
        label_scnu.setScaledContents(True)


        btn_showImg = QPushButton("生成小狗图片", self)
        btn_showImg.setGeometry(50, 60,120,40)
        btn_showImg.clicked.connect(self.generate)
        btn_showImg.setStyleSheet(
            "QPushButton{"
            "background-color: rgb(255, 106, 106);"
            "color: white;"
            "font: bold 16px;"
            "border-radius: 10px;"
            "border: 2px solid rgb(224, 255, 255);"
        ...
        btn_showImg = QPushButton("下一张", self)
        btn_showImg.setGeometry(50, 160, 120, 40)
        btn_showImg.clicked.connect(self.read)
        btn_showImg.setStyleSheet(
            "QPushButton{"
            "background-color: rgb(255, 106, 106);"
            "color: white;"
        ...
        btn_quit.setGeometry(730, 10,60,40)
        btn_quit.clicked.connect(QCoreApplication.quit)
        ...
        btn_aboutus = QPushButton("关于我们", self)
        btn_aboutus.setGeometry(50, 260,120,40)
        btn_aboutus.clicked.connect(self.aboutUsEvent)
        btn_aboutus.setStyleSheet(
            "QPushButton{"
            "background-color: rgb(255, 106, 106);"
            "color: white;"
            "font: bold 16px;"
